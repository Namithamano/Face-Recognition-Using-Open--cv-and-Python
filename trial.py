...
face_cascade = cv2.CascadeClassifier(r'C:\Users\manoj\OneDrive\Desktop\project\haarcascade_frontalface_default.xml')
...
with open(r'C:\Users\manoj\OneDrive\Desktop\project\names.txt', 'r') as file:
...
for name in names:
    image = face_recognition.load_image_file(f"C:\\Users\\manoj\\OneDrive\\Desktop\\project\\{name}.jpg")
